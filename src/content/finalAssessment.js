export const finalAssessment = [
  {
    question:
      'Uma pessoa recebeu mensagem com ameaça de bloqueio da conta, link externo e pedido para manter sigilo. Qual é a conduta inicial mais segura?',
    options: [
  ...
  {
    question:
      'No ecossistema de segurança digital, qual alternativa descreve melhor a responsabilidade compartilhada?',
    options: [
  ...
  {
    question:
      'Em um contato suspeito envolvendo falsa central, pedido de código e orientação para instalar aplicativo, quais sinais indicam engenharia social?',
    options: [
  ...
  {
    question:
      'Qual combinação representa uma rotina adequada de higiene digital?',
    options: [
      'Senha única para todos os serviços, backup eventual e permissões sempre aceitas',
      'Senhas únicas, autenticação forte, backups testados, atualizações e revisão de permissões',
      'Troca de senha apenas depois de golpe consumado e uso de SMS como única proteção',
      'Instalação de novos aplicativos sempre que uma mensagem prometer proteção extra',
    ],
    answer: 1,
  },
  {
  ...
  {
    question:
      'Após o furto de um celular usado para banco, e-mail e autenticação, qual medida preventiva teria reduzido o risco antes do incidente?',
    options: [
  ...
  {
    question:
      'Uma suposta equipe de suporte envia um link para instalar aplicativo fora da loja oficial. Qual é a resposta correta?',
    options: [
  ...
  {
    question:
      'Qual prática reduz riscos em redes domésticas e conexões fora de casa?',
    options: [
  ...
  {
    question:
      'Em compra por marketplace, o vendedor pede pagamento por Pix fora da plataforma e oferece grande desconto. Qual é a avaliação mais adequada?',
    options: [
  ...
  {
    question:
      'Após vazamento de dados, uma pessoa passa a receber mensagens muito personalizadas. Qual deve ser a postura preventiva?',
    options: [
  ...
  {
    question:
      'Quais evidências devem ser preservadas antes de bloquear um contato suspeito?',
    options: [
      'Apenas uma descrição verbal do ocorrido, sem prints ou dados da transação',
      'Prints, links, números, perfis, e-mails, comprovantes, protocolos, datas e horários',
      'Somente o nome salvo na agenda do celular',
      'Apenas mensagens encaminhadas para grupos públicos',
    ],
    answer: 1,
  },
  {
    question:
      'No registro de ocorrência ou comunicação institucional sobre golpe digital, qual informação ajuda a tornar o relato mais útil?',
    options: [
      'Resumo cronológico, valores, canais usados, identificadores, evidências e medidas já adotadas',
      'Opiniões sobre o suspeito sem dados de contato, horário ou comprovantes',
      'Prints editados para remover todo o contexto da conversa',
      'Apenas o nome do aplicativo usado, sem detalhes sobre a sequência dos fatos',
    ],
    answer: 0,
  },
]
