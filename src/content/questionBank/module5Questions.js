export const module5Questions = [
  {
    id: 'm5-q01',
    question: 'Qual é a principal utilidade de um catálogo de ameaças e golpes digitais?',
    options: [
    ...
    answer: 1,
    explanation:
      'O catálogo ajuda a reconhecer padrões de risco, sinais de alerta e respostas seguras diante de ameaças recorrentes.',
  },
  {
    id: 'm5-q02',
    question: 'Qual situação é típica de phishing?',
    options: [
    ...
    answer: 1,
    explanation:
      'Phishing busca enganar a vítima para obter dados, credenciais, pagamentos ou autorizações por meio de mensagem, link ou página falsa.',
  },
  {
    id: 'm5-q03',
    ...
    answer: 2,
    explanation:
      'Cobranças inesperadas por link devem ser verificadas por canal oficial e independente.',
  },
  {
    id: 'm5-q04',
    ...
    answer: 0,
    explanation:
      'Smishing é uma forma de phishing realizada por SMS ou mensagens de texto.',
  },
  {
    id: 'm5-q05',
    ...
    answer: 1,
    explanation:
      'Senha, token e códigos de verificação são credenciais sensíveis e não devem ser informados por telefone ou mensagem.',
  },
  {
    id: 'm5-q06',
    ...
    answer: 1,
    explanation:
      'Aplicativos recebidos por links ou fora de lojas oficiais podem conter malware ou se passar por apps legítimos.',
  },
  {
    id: 'm5-q07',
    ...
    answer: 1,
    explanation:
      'Ransomware é malware de extorsão que bloqueia ou cifra dados e exige pagamento.',
  },
  {
    id: 'm5-q08',
    ...
    answer: 1,
    explanation:
      'Backups atualizados e separados permitem recuperar dados em caso de perda, falha ou ataque.',
  },
  {
    id: 'm5-q09',
    question: 'Qual é um sinal de aplicativo falso?',
    options: [
    ...
    answer: 1,
    explanation:
      'Aplicativos falsos podem imitar nomes e marcas legítimas, mas aparecem com desenvolvedores estranhos ou permissões abusivas.',
  },
  {
    id: 'm5-q10',
    question: 'Em redes sociais, qual situação exige confirmação por outro canal?',
    options: [
    ...
    answer: 0,
    explanation:
      'Pedido de dinheiro por suposto conhecido, especialmente com novo número e urgência, deve ser confirmado por outro canal.',
  },
  {
    id: 'm5-q11',
    ...
    answer: 1,
    explanation:
      'Senha forte, não reutilização e verificação em duas etapas reduzem risco de invasão de contas.',
  },
  {
    id: 'm5-q12',
    question: 'Qual é um sinal de falsa venda?',
    options: [
    ...
    answer: 0,
    explanation:
      'Preço muito baixo e pagamento externo são sinais recorrentes de falsa venda ou golpe em marketplace.',
  },
  {
    id: 'm5-q13',
    ...
    answer: 1,
    explanation:
      'O vendedor deve confirmar entrada real do valor ou validação pela plataforma antes de entregar o produto.',
  },
  {
    id: 'm5-q14',
    question: 'Qual conduta é segura diante de anúncio patrocinado com preço irreal?',
    options: [
    ...
    answer: 1,
    explanation:
      'Anúncios patrocinados também podem ser usados por golpistas; a loja deve ser verificada por canal oficial.',
  },
  {
    id: 'm5-q15',
    question: 'Qual é um sinal comum de boato ou desinformação?',
    options: [
    ...
    answer: 1,
    explanation:
      'Boatos frequentemente usam urgência, títulos alarmistas e pedidos de compartilhamento para ampliar alcance.',
  },
  {
    id: 'm5-q16',
    question: 'Antes de compartilhar notícia alarmista, o que fazer?',
    options: [
    ...
    answer: 1,
    explanation:
      'A verificação da fonte, data e contexto reduz a disseminação de boatos e golpes.',
  },
  {
    id: 'm5-q17',
    question: 'Qual risco deepfakes e áudios sintéticos podem trazer?',
    options: [
    ...
    answer: 1,
    explanation:
      'Conteúdos sintéticos podem imitar imagem ou voz de pessoas, aumentando a credibilidade de golpes.',
  },
  {
    id: 'm5-q18',
    ...
    answer: 1,
    explanation:
      'Senha vazada deve ser substituída em todos os serviços afetados, especialmente se foi reutilizada.',
  },
  {
    id: 'm5-q19',
    ...
    answer: 1,
    explanation:
      'Dados vazados podem alimentar golpes mais convincentes e tentativas de fraude de identidade.',
  },
  {
    id: 'm5-q20',
    question: 'Qual é a primeira pergunta diante de mensagem suspeita?',
    options: [
    ...
    answer: 1,
    explanation:
      'Identificar origem, canal e ação solicitada é etapa inicial para avaliar risco.',
  },
  {
    id: 'm5-q21',
    question: 'Qual pedido é típico de golpe de falsa central?',
    options: [
    ...
    answer: 1,
    explanation:
      'Conta segura é narrativa fraudulenta usada para induzir transferência pela própria vítima.',
  },
  {
    id: 'm5-q22',
    question: 'Qual evidência é útil preservar em tentativa de golpe?',
    options: [
    ...
    answer: 1,
    explanation:
      'Evidências digitais ajudam em contestação, orientação, registro de ocorrência e eventual investigação.',
  },
  {
    id: 'm5-q23',
    ...
    answer: 2,
    explanation:
      'Anexos inesperados podem conter malware; a origem deve ser confirmada antes da abertura.',
  },
  {
    id: 'm5-q24',
    question: 'Qual permissão em aplicativo deve gerar atenção especial quando não é compatível com sua finalidade?',
    options: [
    ...
    answer: 1,
    explanation:
      'Permissões sensíveis podem permitir captura de dados, códigos, contatos ou controle indevido do dispositivo.',
  },
  {
    id: 'm5-q25',
    ...
    answer: 2,
    explanation:
      'Urgência e link encurtado são sinais de alerta; a verificação deve ser feita no canal oficial.',
  },
  {
    id: 'm5-q26',
    ...
    answer: 1,
    explanation:
      'Muitos golpes combinam engenharia social, urgência e manipulação emocional para induzir ação da vítima.',
  },
  {
    id: 'm5-q27',
    ...
    answer: 2,
    explanation:
      'Reduzir exposição e ser seletivo com contatos diminui oportunidades para golpes e abuso de dados.',
  },
  {
    id: 'm5-q28',
    ...
    answer: 1,
    explanation:
      'Códigos de verificação podem permitir invasão ou recuperação de contas e não devem ser compartilhados.',
  },
  {
    id: 'm5-q29',
    ...
    answer: 1,
    explanation:
      'Em extorsão, é importante preservar evidências e buscar ajuda adequada, evitando novas exposições ou pagamentos impulsivos.',
  },
  {
    id: 'm5-q30',
