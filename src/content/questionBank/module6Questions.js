export const module6Questions = [
  ...
  {
    question: 'Qual sequência representa uma resposta adequada a incidente digital?',
    options: [
      'Conter o dano, preservar evidências, acionar canais oficiais e registrar o ocorrido.',
      'Apagar conversas, bloquear o contato, postar alerta público e aguardar contato do banco.',
      'Continuar conversando, negociar devolução, transferir pequeno valor e registrar depois.',
      'Trocar apenas a senha da rede social e ignorar as demais contas.',
    ],
    answer: 0,
  },
  {
  ...
  {
    question: 'Qual item é uma evidência digital útil em caso de golpe online?',
    options: [
      'Comentário genérico de terceiros sobre golpes parecidos.',
      'Prints, links, perfis, números, comprovantes, datas, horários e protocolos.',
      'Print editado para ocultar todos os dados relevantes do caso.',
      'Mensagem reescrita de memória sem data nem identificação do canal usado.',
    ],
    answer: 1,
  },
  {
    question: 'Por que preservar evidências antes de bloquear um perfil suspeito?',
    options: [
  ...
  {
    question: 'Em caso de furto de celular, qual medida deve ser priorizada?',
    options: [
  ...
  {
    question: 'Qual conta costuma ser especialmente crítica após furto de celular ou invasão?',
    options: [
  ...
  {
    question: 'Qual informação é útil para registro de ocorrência envolvendo fraude digital?',
    options: [
      'Apenas o nome popular do golpe.',
      'Resumo cronológico, valores, datas, links, perfis, contas, comprovantes e protocolos.',
      'Somente a opinião da vítima sobre quem pode ter praticado o crime.',
      'Apenas a marca do aparelho usado pela vítima.',
    ],
    answer: 1,
  },
  {
  ...
  {
    question: 'Qual é o papel dos protocolos de atendimento em uma resposta a incidente?',
    options: [
      'Servem apenas para controle interno da empresa e não têm utilidade para a vítima.',
      'Ajudam a comprovar que a instituição foi acionada e quais providências foram solicitadas.',
      'Substituem a necessidade de preservar comprovantes e conversas.',
      'Impedem automaticamente qualquer prejuízo financeiro.',
    ],
    answer: 1,
  },
  {
    question: 'Qual medida é adequada após suspeita de aplicativo malicioso instalado por orientação de falso suporte?',
    options: [
  ...
  {
    question: 'Qual prática de comunicação deve ser evitada após sofrer golpe?',
    options: [
  ...
  {
    question: 'Qual ação ajuda a conter dano após invasão de rede social?',
    options: [
  ...
  {
    question: 'Qual é a finalidade da contenção em resposta a incidentes?',
    options: [
  ...
  {
    question: 'Qual atitude é correta ao receber arquivo suspeito durante um incidente?',
    options: [
  ...
  {
    question: 'Por que não se deve confrontar o golpista antes de preservar evidências?',
    options: [
  ...
  {
    question: 'Qual medida é recomendada para reduzir impacto de ransomware ou perda de dados?',
    options: [
  ...
  {
    question: 'Qual é a melhor forma de registrar a sequência dos acontecimentos?',
    options: [
  ...
  {
    question: 'Após recuperação de conta invadida, qual verificação adicional é importante?',
    options: [
  ...
  {
    question: 'Qual resposta é adequada se contatos receberam mensagens fraudulentas enviadas pela sua conta invadida?',
    options: [
  ...
  {
    question: 'O que deve ser feito antes de instalar qualquer aplicativo indicado por suposto atendente?',
    options: [
